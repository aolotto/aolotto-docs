...
当前开放了基于**Aolotto**利润共享代币 $ALT ([altoken](altoken.md))的投注进程**Aolotto\*ALT**，支持使用$ALT 下注， $ALT 100%面向社区公平发行，您可以通过[水龙头](shui-long-tou.md)免费获取$ALT参与测试。未来，**Aolotto**将逐步开放其他AO标准代币的投注进程，基于AO原生代币的投注进程(**Aolotto\*AO**)将于明年2月$AO流通后开放。
